        ...
        for k = 1:Np
            ...
            for l = 1:Nk
                ...
                for m=1:Na
                    if ni==50 && j>=4
                        a1=a1_all(m);
                        filename=['C:\Users\n15075\Desktop\data\',num2str(ni),'_',num2str(j),'_',num2str(num_k),'_',num2str(p),'_',num2str(a1),'.mat'];
                        load(filename);
                        %
                        t1=tic;
                        ...
                        %
                        savename=['C:\Users\n15075\Google Drive\Matlab\Location_RO_12\COMPARE\Result\',num2str(ni),'_',num2str(j),'_',num2str(num_k),'_',num2str(p),'_',num2str(a1),'.mat']
